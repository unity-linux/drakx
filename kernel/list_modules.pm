...
our %l = (
  ...
  network => 
  {
    ...
    main => [
      ...
      qw(lxt marwell marwell10g mdio-bitbang mdio-cavium mdio-gpio mdio-thunder micrel microchip mscc national),
      ...
      qw(qsemi r8152 r815x realtek rockchip smsc spi_ks8995 ste10Xp teranetics vitesse xilinx_gmii2rgmii),
    ],
  ...
  bus => 
  {
    ...
    hid => [ qw(ff-memless hid hid-a4tech hid-apple hid-appleir hid-asus hid-aureal hid-axff hid-belkin hid-betopff
	    ...
	    hid-logitech hid-logitech-dj hid-logitech-hidpp hid-magicmouse hid-mf hid-microsoft hid-monterey
	    hid-multilaser hid-multitouch hid-ntrig hid-ortek hid-penmount hid-petalynx hid-picolcd
	    hid-pl hid-plantronics hid-primax hid-prodikeys hid-retrode id-roccat hid-roccat-arvo hid-roccat-common hid-rmi
